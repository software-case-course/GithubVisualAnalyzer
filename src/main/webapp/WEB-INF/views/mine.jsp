...
<div class="adcenter"><script src="Lumino%20-%20Dashboard_files/ca-pub-1542822386688301.js"></script><script src="Lumino%20-%20Dashboard_files/ggad2_728x90.js"></script><link type="text/css" rel="stylesheet" href="Lumino%20-%20Dashboard_files/astyle.css">
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="mine"><span class="glyphicon glyphicon-user"></span> 我的</a></li>
       ...
       <div class="row">
			<div class="col-lg-4">
				<div class="panel panel-default">
					<div class="panel-heading"> 名字 下面是用户图片</div>
            ...
            <div class="col-md-4">
                ...
                <div class="panel panel-default chat">
                    <div class="panel-heading dark-overlay"><span class="glyphicon glyphicon-check"></span>关注仓库   </div>
                    <div class="panel-body">
                        <ul class="todo-list">
            ...
            <div class="col-md-4">
                ...
                <div class="panel panel-default chat">
                    <div class="panel-heading dark-overlay"><span class="glyphicon glyphicon-check"></span>关注者   </div>
                    <div class="panel-body">
                        <ul class="todo-list">
                            <li class="collection-item">
    ...
    , {
        ...
        myChart.setOption(option);
		  ...
		  <div class="col-xs-6 col-md-5 col-lg-12 col-lg-offset-0">
				...
				<div class="panel panel-default">
					<div class="panel-heading">我的仓库排行</div>
					<div class="panel-body">
						<div class="canvas-wrapper">
...
<tr>
    ...
    <td>62</td>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">我的贡献图</div>
					<div class="panel-body">
						<div class="canvas-wrapper">
