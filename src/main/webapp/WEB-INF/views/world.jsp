			...
			<div class="navbar-header">
				...
				<ul class="user-menu">
					<li class="dropdown pull-right">
						<a href="../index" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span> 用户 <span class="caret"></span></a>
		...
		<ul class="nav menu">
			...
			<li class="parent ">
				...
				<ul class="children collapse" id="sub-item-1">
							...
							<li><a href="china"><span class="glyphicon glyphicon-stats"></span> 中国</a></li>
						
							<li class="active"><a href="world"><span class="glyphicon glyphicon-stats"></span> 全世界</a></li>
        ...
        myChart.setOption(option);
			...
			<div class="col-lg-12">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="canvas-wrapper">                                          <div id="main1" style="width:100%;height:600px;"></div>
    <script type="text/javascript">
